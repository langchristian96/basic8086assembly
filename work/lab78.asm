;Lang Christian-Gabriel, gr. 911, 26.11.2015, homework for lab 7, problem 8
ASSUME cs: code, ds:data
   ;spunem asamblorului care sunt segmentele folosite de noi
data SEGMENT 
sir DB 2,4,2,5,2,2,4,4,'a','b','c','d','a','b','c' 
...
start:
   ...
   parcurgere:
	...
	mov si,offset sir
	mov cx,len
	dec cx;we compare an element with the next one from the array sir so cx must be len-1
